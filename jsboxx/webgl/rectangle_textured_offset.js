...
µ.WebGL_Rectangle_Textured_Offset = function(gl, cameras, textures)
{
...
(function () {/*
	void main()
	{
		vec4 texColor = texture2D(uSampler, vec2(vTexPosition[0] * vTexScale[0] + vTexOffset[0], vTexPosition[1] * vTexScale[1] + vTexOffset[1]));
		if (vColor[2] < 0.0)
		{
...
*/
	...
	this.program.aTexOffset			= gl.getAttribLocation(this.program, "aTexOffset");
...
µ.WebGL_Rectangle_Textured_Offset.prototype.draw_rectangle = function(
		cam_id,
		texture_id,
		pos_x, pos_y,
		size_x, size_y,
...
µ.WebGL_Rectangle_Textured_Offset.prototype.draw_line = function(
		cam_id,
		texture_id,
		pos1_x, pos1_y,
		pos2_x, pos2_y,
...
µ.WebGL_Rectangle_Textured_Offset.prototype.draw = function(
		cam_id,
		texture_id,
		pos_x, pos_y,
		width, height,
...
//*/
	...
	this.vbuffer[cam_id][texture_id][offset + index] = offset_x;									index++;
	this.vbuffer[cam_id][texture_id][offset + index] = offset_y;									index++;
...
µ.WebGL_Rectangle_Textured_Offset.prototype.flush_all = function()
{
	...
	gl.enableVertexAttribArray(this.program.aTexOffset);
	...
	gl.disableVertexAttribArray(this.program.aTexOffset);
	gl.disableVertexAttribArray(this.program.aPosition);
	gl.disableVertexAttribArray(this.program.aColor);
	this.something_to_draw = false;
};

µ.WebGL_Rectangle_Textured_Offset.prototype.flush = function(camera_id, texture_id)
{
	...
	gl.vertexAttribPointer(this.program.aVertexPosition,	2, gl.FLOAT,	false,	56, 0);
	gl.vertexAttribPointer(this.program.aPosition,			2, gl.FLOAT,	false,	56, 8);
	gl.vertexAttribPointer(this.program.aTexPosition,		2, gl.FLOAT,	false,	56, 16);
	gl.vertexAttribPointer(this.program.aTexScale,			2, gl.FLOAT,	false,	56, 24);
	gl.vertexAttribPointer(this.program.aTexOffset,			2, gl.FLOAT,	false,	56, 32);
	gl.vertexAttribPointer(this.program.aColor, 			4, gl.FLOAT,	false,	56, 40);
