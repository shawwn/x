µ.WebGL_Rectangle_Smoke = function(gl, cameras, textures)
{
...
void main()
{
	...
	if (mod((gl_FragCoord[0] * (val) + gl_FragCoord[1] * log(-val)), 2.0) > 1.0)
	{
		gl_FragColor[0] = 0.15;
		gl_FragColor[1] = 0.15;
		gl_FragColor[2] = 0.15;
		gl_FragColor[3] = log(-val);
	}
	else if (mod((gl_FragCoord[0] * val + gl_FragCoord[1] * val), 2.0) > 1.0)
	{
		gl_FragColor[0] = 0.2;
		gl_FragColor[1] = 0.2;
		gl_FragColor[2] = 0.2;
	...
	gl_FragColor[3] = min(0.025, gl_FragColor[3]);
...
*/
	...
	gl.errorCheck('setup rectangle_smoke');
