lgg.etypes[lgg.ENEMY_TYPE__BLORB_BIG] =
{
	armour:					.23,
	...
	engage_range:			0.5,
	follow_chance:			0,
	follow_targets: 		[lgg.ENEMY_TYPE__BLORB_BIG, lgg.ENEMY_TYPE__BLORB_X, lgg.ENEMY_TYPE__BLORB_Y],
	friction:				0.985,
	height:					.85,
	height_tol:				.3,
	id: 					lgg.ENEMY_TYPE__BLORB_BIG,
	joinup_chance:			1,
	linger_max:				120000,
	linger_min:				45000,
	...
	draw:			function(e) {
		...
		var r2 = e.radius*2;
		lgg.c.rectangle_textured.draw(lgg.CAM_PLAYER, lgg.tex_blorb_xy, e.pos_x, e.pos_y, r2, r2, 0,
